...
- **500 from `/api/lead`**: missing or incorrect Apps Script URL variable. Use `APPS_SCRIPT_BASE_URL` (recommended) or `NEXT_PUBLIC_APPS_SCRIPT_BASE_URL`; `SCRIPT_EXEC_URL` is supported for backward compatibility.
