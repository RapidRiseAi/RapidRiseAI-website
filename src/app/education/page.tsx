...
export default function EducationPage(){return <><Hero h1="Practical training for modern work." sub="Help your team communicate better, move faster, and use tools properly." cta2="View Work" visual="/images/sections/workflow-map.svg" />
