...
export default function ContactPage(){return <><Hero h1="Contact" sub="Prefer a quote request? Use the Request a Quote form for faster scoping." visual="/images/sections/proof-strip.svg" />
