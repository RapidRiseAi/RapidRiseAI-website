...
const fixedProducts = [
  ...
  },
  {
    ...
    price: 'R4,000',
    timeline: '2 weeks',
    includes: ['FAQ style assistant', 'Smart handoff to your team', 'Capture name, contact, and issue summary', 'Basic reporting'],
  },
];
  ...
  return (
    <>
      ...
      <Section title="Fixed-price products or custom quoted builds.">
        ...
        <MobileSnapCarousel desktopClassName="md:grid-cols-2" itemClassName="w-[90%] md:w-auto" className="mt-6">
          <Card>
      ...
      <Section title="Fixed-price products" intro="These are packaged systems with defined scope. If you need more, we extend it with add-ons or a custom quote.">
        ...
        <p className="mt-6 text-sm text-text1">Third-party subscriptions, messaging fees, and hosting are billed separately where applicable.</p>
      </Section>
      ...
      <Section title="When we quote instead of using fixed pricing" intro="If the work depends on complex rules, multiple teams, or heavy data movement, fixed pricing stops being honest. That is when we quote.">
        ...
        <MobileSnapCarousel desktopClassName="md:grid-cols-3" itemClassName="w-[84%] md:w-auto" className="mt-4">
          <Card>
