...
export default function BookPage(){return <><Hero h1="Book a Call" sub="If you want, we can walk through your workflow and identify quick wins." visual="/images/sections/dashboard-mock.svg" />
