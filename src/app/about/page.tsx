...
export default function AboutPage(){return <><Hero h1="We build systems that make work easier to run." sub="Less chaos. Better tracking. Faster response." visual="/images/hero/rapid-rise-ai-about-build-philosophy-systems.jpg" alt="System build blueprint and handover pack" />
...
<Section><Card className="flex flex-wrap items-center justify-between gap-4"><h2 className="font-[var(--font-jakarta)] text-2xl font-semibold">Tell us what is currently manual.</h2><Button href="/quote" arrow className="max-md:hidden">Request a Quote</Button></Card></Section></>}
