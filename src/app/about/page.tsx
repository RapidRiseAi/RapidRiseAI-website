...
export default function AboutPage(){return <><Hero h1="We build systems that make work easier to run." sub="Less chaos. Better tracking. Faster response." visual="/images/hero/hero-bg.svg" />
