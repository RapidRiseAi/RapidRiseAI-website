...
export function BusinessLeakMap() {
  ...
  return (
    <section className="business-leak-map-section relative overflow-hidden bg-[linear-gradient(180deg,#030815_0%,#04101f_46%,#030814_100%)] px-5 pb-[88px] pt-[24px] scroll-mt-[120px] sm:px-7 lg:px-10 lg:pb-[116px] lg:pt-[38px]">
