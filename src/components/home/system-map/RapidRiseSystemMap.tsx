  ...
  return (
    <section id="home-hero" className="hero-shell relative overflow-hidden border-b border-white/10 text-white">
      ...
      <style jsx>{`
        ...
        .destination-card { position:relative; display:block; width: 172px; min-height: 132px; padding: 15px 15px 14px; border:1px solid rgba(175,201,232,.56); border-radius:20px; background-color:rgba(8,16,32,.96); background-image:linear-gradient(180deg, rgba(28, 45, 73, 0.98), rgba(8, 16, 32, 0.985)); box-shadow:0 34px 86px rgba(0,0,0,.58),0 14px 36px rgba(2,6,23,.46),0 0 0 1px rgba(96,165,250,.14),inset 0 1px 0 rgba(255,255,255,.2),inset 0 0 0 1px rgba(148,163,184,.28); backdrop-filter: blur(6px); -webkit-backdrop-filter: blur(6px); transition: transform .3s ease, border-color .3s ease, box-shadow .3s ease; overflow:hidden; isolation:isolate; opacity:1; }
        .destination-card::before { content:''; position:absolute; left:0; right:0; top:0; height:56%; background:linear-gradient(180deg, rgba(255,255,255,.2) 0%, rgba(255,255,255,.08) 32%, transparent 100%); pointer-events:none; z-index:1; }
        .destination-card::after { content:''; position:absolute; inset:1px; border-radius:18px; background:linear-gradient(180deg, rgba(255,255,255,.06), rgba(255,255,255,.01) 38%, rgba(2,6,23,.12)); box-shadow:inset 0 0 0 1px rgba(148,163,184,.2); pointer-events:none; z-index:0; }
        .destination-card > :global(*) { position:relative; z-index:2; }
        ...
        .destination-active { border-color:rgba(191,219,254,1); box-shadow:0 0 0 1px rgba(191,219,254,.85),0 0 0 2px rgba(37,99,235,.5),0 34px 92px rgba(14,42,104,.65),0 0 62px rgba(96,165,250,.4),inset 0 1px 0 rgba(255,255,255,.26),inset 0 0 0 1px rgba(219,234,254,.5); }
