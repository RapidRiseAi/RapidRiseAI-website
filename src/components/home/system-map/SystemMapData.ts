...
export const destinations: Destination[] = [
  ...
  { id: 'automation', title: 'Automation', label: 'EFFICIENCY', shortDescription: 'Remove manual work and streamline ops.', description: 'Remove repetitive manual work and create connected workflows that keep the business moving.', href: '/solutions#workflow-automation', icon: Zap, position: { x: 750, y: 175 }, cta: 'Automate My Workflow', secondaryCta: 'Explore automation ideas', benefits: [
  ...
  { id: 'contact', title: 'Contact', label: 'START HERE', shortDescription: 'Start a conversation. Let’s build together.', description: 'Tell us what is slowing your business down and we will help you map the best next step.', href: '/contact', icon: Mail, position: { x: 750, y: 585 }, cta: 'Request a Quote', secondaryCta: 'Send a message', benefits: [
  ...
  { id: 'services', title: 'Services', label: 'FEATURED', shortDescription: 'Core systems & strategy that drive real results.', description: 'We design and implement core systems that power your business, so you can focus on growth, not busywork.', href: '/solutions', icon: Sparkles, position: { x: 500, y: 635 }, cta: 'Explore Services', secondaryCta: 'View all solutions', benefits: [
