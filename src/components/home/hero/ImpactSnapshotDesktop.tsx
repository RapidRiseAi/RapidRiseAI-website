...
export function ImpactSnapshotDesktop() {
  ...
  const accentShell: Record<string, string> = {
    TIME: 'border-cyan-300/42 bg-[linear-gradient(160deg,rgba(6,18,38,0.98)_0%,rgba(3,9,20,0.95)_56%,rgba(8,32,58,0.8)_100%)]',
    SPEED: 'border-teal-300/42 bg-[linear-gradient(160deg,rgba(4,23,36,0.98)_0%,rgba(2,11,23,0.95)_56%,rgba(5,46,54,0.8)_100%)]',
    'FOLLOW-UP': 'border-violet-300/42 bg-[linear-gradient(160deg,rgba(22,13,42,0.98)_0%,rgba(13,9,30,0.95)_56%,rgba(39,20,64,0.8)_100%)]',
    VISIBILITY: 'border-blue-300/42 bg-[linear-gradient(160deg,rgba(7,18,46,0.98)_0%,rgba(2,9,24,0.95)_56%,rgba(8,32,69,0.82)_100%)]',
  };
        ...
        {impactMetrics.map((metric, index) => {
          ...
          return (
            <motion.article
              ...
              className={`group relative min-h-[186px] overflow-hidden rounded-2xl border p-[1.5rem] shadow-[inset_0_1px_0_rgba(255,255,255,0.13),inset_0_0_0_1px_rgba(148,163,184,0.1),0_12px_34px_rgba(2,6,23,0.6),0_0_20px_rgba(15,23,42,0.24)] before:pointer-events-none before:absolute before:inset-0 before:opacity-90 before:content-[''] after:pointer-events-none after:absolute after:inset-x-6 after:top-0 after:h-px after:bg-gradient-to-r after:from-transparent after:via-cyan-100/56 after:to-transparent after:content-[''] transition duration-300 hover:-translate-y-0.5 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.2),inset_0_0_0_1px_rgba(186,230,253,0.14),0_16px_44px_rgba(2,6,23,0.7)] ${accentShell[metric.tag]} ${accentAtmosphere[metric.tag]}`}
            >
              <div className="relative flex items-center gap-3">
                <span className={`inline-flex h-12 w-12 items-center justify-center rounded-full border bg-[radial-gradient(circle,rgba(15,23,42,0.99),rgba(2,6,23,0.95))] shadow-[inset_0_1px_0_rgba(255,255,255,0.19),0_0_0_1px_rgba(148,163,184,0.16)] transition duration-300 ${iconAccent[metric.tag]}`}>
                  <Icon strokeWidth={2.1} className={`h-[1.36rem] w-[1.36rem] ${metric.accent} transition duration-300 group-hover:brightness-125`} />
                </span>
