...
export function MaintenanceGate() {
  ...
  return (
    <div
      className={`fixed inset-0 z-[9999] h-[100dvh] w-screen overflow-y-auto bg-[#020617] [background-image:linear-gradient(rgba(148,163,184,0.12)_1px,transparent_1px),linear-gradient(90deg,rgba(148,163,184,0.12)_1px,transparent_1px),radial-gradient(circle_at_15%_18%,rgba(34,211,238,0.2),transparent_42%),radial-gradient(circle_at_82%_22%,rgba(37,99,235,0.2),transparent_40%),linear-gradient(to_bottom,#020617,#050816_55%,#04060f)] [background-size:46px_46px,46px_46px,auto,auto,auto] text-white transition-transform duration-500 ease-in ${hasAccess ? 'translate-y-full opacity-0 pointer-events-none' : 'translate-y-0 opacity-100'}`}
      aria-hidden={hasAccess}
    >
      <div className="relative mx-auto flex min-h-full w-full max-w-6xl flex-col px-6 py-8 pb-28 sm:px-8 lg:px-10">
      ...
      <div className="group fixed bottom-4 left-4 z-[10020] h-[84px] w-[120px]">
        <div aria-hidden className="h-full w-full opacity-0" />
        <div className="pointer-events-none absolute bottom-0 left-0 w-[320px] translate-y-2 opacity-0 transition duration-200 group-hover:pointer-events-auto group-hover:translate-y-0 group-hover:opacity-100 group-focus-within:pointer-events-auto group-focus-within:translate-y-0 group-focus-within:opacity-100">
