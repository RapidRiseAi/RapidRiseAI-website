...
export function MaintenanceGate() {
  ...
  return (
    ...
    >
      <div className="relative mx-auto flex min-h-full w-full max-w-6xl flex-col bg-[radial-gradient(circle_at_15%_18%,rgba(34,211,238,0.2),transparent_42%),radial-gradient(circle_at_82%_22%,rgba(37,99,235,0.2),transparent_40%),linear-gradient(to_bottom,#020617,#050816_55%,#04060f)] px-6 py-8 pb-24 sm:px-8 lg:px-10">
